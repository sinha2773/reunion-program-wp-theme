     ...
     <div class="main_registration_page">
      <div class="registration_page_all_information">
         <div class="registration_page_header_information">
           ...
           <div class="download_or_scan">
             <div class="download_form">
              ...
              <div class="scan_form">
                <a href="">
                 <button class="btn-sm">রেজিষ্ট্রেশনের স্কেন কপি পাঠাটে ক্লিক করুন</button>
                </a>
              </div>
            </div>
         </div>
         ...
         <div class="person_all_information">
           <form class="" action="#" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
    				<div class="form-group registration_form_payment registration_payment_method ">
    				  ...
    				  <div class="">
    					   <input type="file" class="form-control" id="reg_scan_copy" placeholder="">
    				  </div>				  
    				</div>
